...
--  constant VENDOR_PROTON     : amba_vendor_type := 16#EB#;
...
-- Team PROTON
--  constant PROTON_ADC    	 : amba_device_type := 16#100#;
--  constant PROTON_PWM    	 : amba_device_type := 16#101#;
...
--  constant PROTON_DESC : vendor_description :=  "Team Proton             ";

--  constant proton_device_table : device_table_type := (
--   PROTON_ADC  	 => "XADC IP wrapper for Artix 7    ",
--   PROTON_PWM    => "PWM wrapper comp. w/ Nexsys 4  ",
   
--   others            => "Unknown Device                 ");
   
--  constant proton_lib : vendor_library_type := (
--    vendorid     => VENDOR_PROTON,
--    vendordesc   => PROTON_DESC,
--    device_table => proton_device_table
--  );
